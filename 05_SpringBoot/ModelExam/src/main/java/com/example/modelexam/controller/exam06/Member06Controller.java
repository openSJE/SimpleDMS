...
//    결과를 뷰로(exam02/member_id.html)로 전송해보세요.
    ...
    @Autowired
    Member05Service memberService; // 스프링부트 컨테이너의 객체 하나 받아오기
    ...
    public String getMemberAll(Model model) {
        ...
        return "/exam05/member_all.html"; // .html 홈페이지 이동
    }
    ...
    public String getMemberId(@PathVariable long eno, Model model){
        ...
        return "/exam05/member_id.html"; // dept_id.html 홈페이지로 이동
    }


    @GetMapping("/member/addition")
    public String addMember() {
        return "/exam05/add_member.html"; // 부서정보 추가 페이지 경로
    }
    ...
    public RedirectView createMember(@ModelAttribute Member member) {
        ...
        return new RedirectView("/exam05/member"); // 전체 부서 정보 페이지로 강제 이동
    }
    ...
    public String editMember(@PathVariable long eno, Model model){
        ...
        return "exam05/update_member.html";
    }
    ...
    public RedirectView updateMember(@PathVariable int eno, @ModelAttribute Member member){
        ...
        return new RedirectView("/exam05/member"); // 부서정보 첫페이지 강제 이용
    }
