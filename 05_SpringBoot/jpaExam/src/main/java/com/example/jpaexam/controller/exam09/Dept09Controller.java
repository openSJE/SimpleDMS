...
public class Dept08Controller {
    ...
    @Autowired
    Dept08Service dept08Service; // @Autowired : Springboot 가 가동될 때 생성된 객체를 하나 받아오기
    ...
    public ResponseEntity<Object> getDeptAll() {
        ...
        try {
            List<Dept> list = dept08Service.findAll();
...
//            서버에서 발생 메세지 전송 (클라이언트)
    ...
    public ResponseEntity<Object> getDeptId(@PathVariable int dno) {
        ...
        try {
            Optional<Dept> ooptionalDelpt = dept08Service.findById(dno);
